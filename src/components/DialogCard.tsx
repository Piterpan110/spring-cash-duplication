      ...
      <form>
        ...
        >
          ...
          <div className="flex relative md:flex-row flex-col">
            ...
            />
            <DialogClose className="z-2 bg-[#F9F9F9] ring-offset-background focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-[#333333] absolute top-7 right-6 rounded-full opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 p-0.5">
              <XIcon />
              <span className="sr-only">Close</span>
            </DialogClose>
            <div className="md:mt-4 mt-0 md:mb-4 mb-0 md:mr-3.5 mr-0 md:ml-auto ml-0 md:w-[468px] w-[100%] md:rounded-[12px] px-1 py-2 z-1 bg-white d-flex">
              <div className="h-[100%] flex">
                <div className="my-auto mx-auto">
                  <p className="font-medium text-[32px] leading-[100%] tracking-[-0.02em] text-center ">
